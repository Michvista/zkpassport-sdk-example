...
import {
  ...
  type AvailableChartColorsKeys, chartColorHex
} from "@/lib/chartUtils"
...
const AreaChart = React.forwardRef<HTMLDivElement, AreaChartProps>(
 ...
 const getFillContent = ({
  ...
  // ✅ compute the correct color here
  const chartColor = categoryColors.get(category) as AvailableChartColorsKeys
  ...
  switch (fillType) {
    ...
    case "gradient":
      return (
        <>
          <stop
            offset="5%"
            stopColor={chartColorHex[chartColor]}
            stopOpacity={0.3}
          />
          <stop
            offset="95%"
    ...
    case "solid":
    default:
      return <stop stopColor={chartColorHex[chartColor]} stopOpacity={stopOpacity} />
  }
}
  ...
  tick={({ x, y, payload }) => (
    <text
      x={x + 6}                // horizontal padding
      y={y + 12}                // vertical padding
      textAnchor="middle"
      fill="#374151"
      fontSize={10}
    >
