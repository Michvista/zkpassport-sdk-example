...
import { Calendar as CalendarPrimitive, type Matcher } from "@/components/ui/Calendar"
...
const SingleDatePicker = ({
  ...
  disabled={disabled}
  className={cx(
    "peer flex items-center gap-x-2 w-60 px-3 py-2 rounded-md border shadow-sm text-sm transition focus:outline-none focus:ring-2 focus:ring-blue-500",
    "!bg-white !text-black hover:!bg-gray-50 border-gray-300",   // Always white bg + black text
    "!dark:bg-white !dark:text-black !dark:hover:bg-gray-50",    // Kill dark mode
